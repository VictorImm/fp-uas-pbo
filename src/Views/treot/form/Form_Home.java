...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/Views/treot/icon/profile.jpg")), "Jonh", "Male", "Java", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/Views/treot/icon/profile1.jpg")), "Dara", "Male", "C++", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/Views/treot/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/Views/treot/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/Views/treot/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/Views/treot/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/Views/treot/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
    ...
    private void initComponents() {
        ...
        card1 = new Views.treot.component.Card();
        jLabel1 = new javax.swing.JLabel();
        card2 = new Views.treot.component.Card();
        card3 = new Views.treot.component.Card();
        card4 = new Views.treot.component.Card();
        jPanel1 = new javax.swing.JPanel();
        noticeBoard = new Views.treot.swing.noticeboard.NoticeBoard();
        ...
        table1 = new Views.treot.swing.table.Table();
    ...
    private Views.treot.component.Card card1;
    private Views.treot.component.Card card2;
    private Views.treot.component.Card card3;
    private Views.treot.component.Card card4;
    ...
    private Views.treot.swing.noticeboard.NoticeBoard noticeBoard;
    private Views.treot.swing.table.Table table1;
