...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMenu = new Views.treot.swing.Button();
        pic = new Views.treot.swing.ImageAvatar();
        lbUserName = new javax.swing.JLabel();
        lbRole = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        buttonBadges1 = new Views.treot.swing.ButtonBadges();
        buttonBadges2 = new Views.treot.swing.ButtonBadges();

        setBackground(new java.awt.Color(255, 255, 255));

        cmdMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/treot/icon/menu.png"))); // NOI18N

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/treot/icon/profile.jpg"))); // NOI18N
        ...
        buttonBadges1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/treot/icon/notification.png"))); // NOI18N
        buttonBadges1.setBadges(12);

        buttonBadges2.setForeground(new java.awt.Color(63, 178, 232));
        buttonBadges2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/treot/icon/message.png"))); // NOI18N
    ...
    private Views.treot.swing.ButtonBadges buttonBadges1;
    private Views.treot.swing.ButtonBadges buttonBadges2;
    private Views.treot.swing.Button cmdMenu;
    private javax.swing.JSeparator jSeparator1;
    private javax.swing.JLabel lbRole;
    private javax.swing.JLabel lbUserName;
    private Views.treot.swing.ImageAvatar pic;
