...
public class ModelLocalStorage {
    ...
    public ModelLocalStorage(String id, String soal, String jawaban1, String jawaban2, String jawaban3, String jawaban4, String jawaban5) {
        this.id = id;
        this.soal = soal;
        this.jawaban1 = jawaban1;
        this.jawaban2 = jawaban2;
